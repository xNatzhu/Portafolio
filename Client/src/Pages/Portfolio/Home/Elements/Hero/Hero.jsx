    ...
    return(
        <div className="bg-[#222434] hero h-[110vh] w-[100%] px-[30px] flex items-center relative">
            ...
            <div className="flex-col md:w-1/2 h-auto z-20">
                ...
                <button className="bg-[#0ef0ad] text-[#222434] hover:bg-[#09926a] hover:text-[#fff] text-[16px] font-bold py-[13px] px-[25px] rounded-[16px] inline-flex items-center mt-[30px] transition-all duration-300 ease-in-out">
                    <svg
